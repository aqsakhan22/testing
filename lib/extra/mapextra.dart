...
//   int counter = UserPreferences.idleTime;
...
//       //   TripProvider().updateTrip().then((value) {
//       //     print("Updating Map After Updating Data To Server ${value}");
//       //     updateMap(value);
//       //   });
//       // });
//
...
//     print("updateMap() ${runprogressdetails}");
//     print("idleTime is  ${UserPreferences.idleTime} duration is ${UserPreferences.Tripduration}");
//     setState(() {
//       getAddress=runprogressdetails['address'];
//       G_ACCValue=runprogressdetails['GCC'];
//       headingAngle=runprogressdetails['heading'];
...
//         setState(() {
//           counter++;
//           UserPreferences.idleTime=counter;
//         });
//       }
//
//     });
...
//               markerId: MarkerId("${LatLng(runprogressdetails['latitude'],runprogressdetails['longitude'])}"),
//               position: LatLng(runprogressdetails['latitude'],runprogressdetails['longitude']), //position of marker
