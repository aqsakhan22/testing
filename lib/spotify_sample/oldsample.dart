...
//               children: <Widget>[
//                 ElevatedButton(onPressed: skipPrevious, child: Icon(Icons.skip_previous)),
//                 ElevatedButton(onPressed: resume, child: Icon(Icons.play_arrow)),
//                 ElevatedButton(onPressed: pause, child: Icon(Icons.pause)),
//                 ElevatedButton(onPressed: skipNext, child: Icon(Icons.skip_next)),
//
//
//               ],
//             ),
...
//               mainAxisAlignment: MainAxisAlignment.spaceEvenly,
//               children: <Widget>[
//                 ElevatedButton(onPressed: queue, child: Icon(Icons.queue_music)),
//
//                ElevatedButton(onPressed: play, child: Icon(Icons.play_circle_filled)),
//                 ElevatedButton(onPressed: toggleRepeat, child: Icon(Icons.repeat)),
//   ElevatedButton(onPressed: toggleShuffle, child: Icon(Icons.shuffle)),
//
//
//
//
